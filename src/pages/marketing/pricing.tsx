...
const faqs = [
  [
    ...
    "Yes — plans change from the Studio Plan screen and pricing is prorated.",
  ],
  [
    "Are VR walkthroughs included?",
    "Studio Pro and Enterprise include VR walkthrough sharing with clients.",
  ],
  [
    "Do clients need an account?",
    "No. Presentation links open in any browser on phone, tablet or laptop.",
  ],
