  ...
  return (
    <>
      <Seo
        ...
        description="Build a shareable presentation of renders, walkthroughs and costs, and collect client approvals."
      />
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        <Section
          title="Slides"
          description="Renders and walkthroughs in presentation order"
          ...
          <ul className="grid gap-3 sm:grid-cols-2">
            {gallery.slice(0, 4).map((g, i) => (
              <li key={g.title} className="min-w-0 overflow-hidden rounded-xl border border-border">
                <div
                  className={`aspect-video w-full bg-gradient-to-br ${g.tone} via-muted to-accent`}
                />
