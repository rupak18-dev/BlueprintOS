  ...
  return (
    <>
      <Seo
        ...
        description="Update your personal details, studio profile, notification preferences and security settings."
      />
      ...
      <Tabs defaultValue="personal" className="gap-4">
        ...
        <TabsContent value="studio">
          <Section
            ...
            description="Shown on quotations and client presentations"
          >
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
