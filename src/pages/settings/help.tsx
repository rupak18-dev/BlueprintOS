...
const faqs: [string, string][] = [
  [
    "How do I turn a won lead into a project?",
    "Open the lead, go to the Quotation tab and mark it won. A project is created with the rooms and estimate already carried over.",
  ],
  [
    "Can clients comment without an account?",
    "Yes. A presentation link is view-only and password protected; clients can approve rooms and leave comments without signing up.",
  ],
  [
    "How are seats counted?",
    "Every staff member with a login uses one seat. Vendor crews and clients do not consume seats.",
  ],
  [
    "Does the 2D plan sync to the 3D studio?",
    "Walls, doors and windows carry across. Furniture placement stays editable separately in the 3D studio.",
  ],
];
  ...
  return (
    <>
      <Seo
        ...
        description="Step-by-step guides for leads, quotations, the 2D planner, 3D studio, procurement and team setup."
      />
            ...
            <li className="flex gap-3 rounded-lg border border-border p-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-muted-foreground">
                  Included with Studio Pro · replies within 4 hours
                </p>
              </div>
            </li>
          </ul>
