  ...
  head: () => ({
    meta: [
      { title: "Atelier Verde — interior design studio workspace" },
      {
        name: "description",
        content:
          "One workspace for interior designers: capture leads, quote, design in 2D and 3D/VR, present to clients, and manage procurement and accounts.",
      },
      { property: "og:title", content: "Atelier Verde — interior design studio workspace" },
      {
        property: "og:description",
        content: "From lead to handover: CRM, 2D planning, 3D/VR presentation, procurement and accounts in one place.",
      },
    ],
  }),
  component: Home,
...
const steps = [
  { icon: Users, title: "Capture the lead", text: "Enquiry details, requirements and site notes in one record." },
  { icon: Wallet, title: "Quote and win", text: "Room-wise estimates roll up into a client-ready quotation." },
  { icon: Ruler, title: "Plan in 2D", text: "Accurate floor plans with walls, openings and room areas." },
  { icon: Boxes, title: "Design in 3D / VR", text: "Furnish from your asset library and walk the space." },
  { icon: MonitorPlay, title: "Present and approve", text: "Share a link, collect comments, get sign-off." },
  { icon: LineChart, title: "Execute and track", text: "Procurement, crew, payments and margin per project." },
];
        ...
        <div className="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:py-28">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <div className="min-w-0">
              <Badge variant="outline" className="border-brass/50 bg-brass/15 text-brass-foreground">
                CRM + 2D + 3D / VR
              </Badge>
              ...
              <p className="mt-4 max-w-xl text-base text-muted-foreground sm:text-lg">
                Atelier Verde takes an interior project from first enquiry to final handover — quotations, floor plans,
                VR walkthroughs, client approvals, procurement and accounts in a single studio workspace.
              </p>
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              {gallery.slice(0, 4).map((g) => (
                ...
                >
                  <p className="text-[11px] uppercase tracking-wide text-muted-foreground">{g.tag}</p>
        ...
        <div className="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 sm:py-20">
          <div className="grid grid-cols-[minmax(0,1fr)_auto] items-end gap-4">
            <div className="min-w-0">
              ...
              <p className="mt-2 text-sm text-muted-foreground">Start solo, grow into a full studio team.</p>
            </div>
