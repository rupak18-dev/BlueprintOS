...
export const Route = createFileRoute("/notifications")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Design approvals, overdue invoices, dispatches and new leads in one activity feed." },
      { property: "og:title", content: "Notifications — approvals, finance and site alerts" },
      { property: "og:description", content: "Approvals, invoices, dispatches and new leads in one feed." },
    ],
  }),
    ...
    <AppShell>
      ...
      <Section title="Activity feed">
        <ul className="divide-y divide-border">
          {notifications.map((n) => (
            <li key={n.id} className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-start gap-3 py-4 first:pt-0">
