...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Set up an interior design studio workspace with a 14-day trial." },
      { property: "og:title", content: "Create your studio — Atelier Verde" },
      { property: "og:description", content: "Set up an interior design studio workspace with a 14-day trial." },
    ],
  }),
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-accent/50 to-background px-4 py-12">
      <Card className="w-full max-w-lg">
        <CardContent className="px-6 py-2">
          ...
          <p className="mt-1 text-sm text-muted-foreground">14-day trial of the full workspace. No card needed.</p>
          <form className="mt-6 grid gap-4 sm:grid-cols-2" onSubmit={(e) => e.preventDefault()}>
            ...
            <Button asChild className="h-11 sm:col-span-2">
              <Link to="/dashboard">Create studio</Link>
            </Button>
          </form>
