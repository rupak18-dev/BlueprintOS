...
export const Route = createFileRoute("/leads/$leadId")({
  ...
  head: ({ loaderData }) => {
    if (!loaderData) {
      return { meta: [{ title: "Lead not found" }, { name: "robots", content: "noindex" }] };
    }
    const title = `${loaderData.lead.name} — lead detail`;
    return {
      meta: [
        { title },
        { name: "description", content: `Requirements, room notes and estimate for ${loaderData.lead.name}.` },
        { property: "og:title", content: title },
        { property: "og:description", content: `Requirements, room notes and estimate for ${loaderData.lead.name}.` },
      ],
    };
  },
