...
export const Route = createFileRoute("/studio-plan")({
  head: () => ({
    meta: [
      { title: "Studio Plan — subscription, seats and billing" },
      { name: "description", content: "Current plan, seat usage, invoices and upgrade options for your design studio." },
      { property: "og:title", content: "Studio Plan — subscription, seats and billing" },
      { property: "og:description", content: "Plan, seats, billing history and upgrade options." },
    ],
  }),
  component: StudioPlanPage,
});
    ...
    <AppShell>
      ...
      >
        <ul className="divide-y divide-border">
          {billing.map((b) => (
            <li key={b.id} className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 py-3 first:pt-0">
